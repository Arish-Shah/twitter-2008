...
export default function Privacy() {
  return (
    <Main>
      <Main.P className="mb-[15px]">
        This Privacy Policy is effective as of May 14, 2007.
      </Main.P>
      <Main.H2>Twitter Privacy Policy</Main.H2>
      <Main.P className="mb-[15px]">
      ...
      <Main.H3>Information Collection and Use</Main.H3>
      <Main.P className="mb-[15px]">
        Our primary goals in collecting personally identifiable information are
        to provide you with the product and services made available through the
        Site, including, but not limited, to the Service, to communicate with
        you, and to manage your registered user account, if you have one.
      </Main.P>
      <Main.P className="mb-[15px]">
        <b>Information Collected Upon Registration</b>. If you desire to have
        access to certain restricted sections of the Site, you will be required
        to become a registered user, and to submit certain personally
        identifiable information to Twitter. This happens in a number of
        instances, such as when you sign up for the Service, or if you desire to
        receive marketing materials and information. Personally identifiable
        information that we may collect in such instances may include your IP
        address, full user name, password, email address, city, time zone,
        telephone number, and other information that you decide to provide us
        with, or that you decide to include in your public profile.
      </Main.P>
      <Main.P className="mb-[15px]">
        <b>Additional Information</b> Your full user name and your photo, if you
        decide to upload one, are displayed to people in the Twitter network to
        enable you to connect with people on Twitter, as specified in your
        privacy settings. Once a member, you may provide additional information
        in the profile section, including but not limited to your bio, your
        location, as well as your personal web site, if you have one. Providing
        additional information beyond what is required at registration is
        entirely optional, but enables you to better identify yourself and find
        new friends and opportunities in the Twitter system. If you activate the
        mobile phone or Instant Messaging options per the Terms of Service at{" "}
        <Link href="/tos">www.twitter.com/tos</Link>, we will collect your
        cellular phone number and IM account information. You will receive
        notifications on your cellular phone or your IM account in a number of
        cases, such as when a Twitter member adds you as a friend or sends you a
        message. If you contact us by email through the Site, we may keep a
        record of your contact information and correspondence, and may use your
        email address, and any information that you provide to us in your
      ...
      <Main.P className="mb-[15px]">
        ...
        our products and services, including but not limited to our Service. If
      ...
      <Main.P className="mb-[15px]">
        ...
        Site, and to improve the Site and our services. A session cookie enables
        certain features of the Site and our service and is deleted from your
        computer when you disconnect from or leave the Site. A persistent cookie
        remains after you close your browser and may be used by your browser on
        subsequent visits to the Site. Persistent cookies can be removed by
        following your web browser help file directions. Most Internet browsers
        automatically accept cookies. You can instruct your browser, by editing
        its options, to stop accepting cookies or to prompt you before accepting
        a cookie from the websites you visit.
      </Main.P>
      <Main.H3>Information Sharing and Disclosure</Main.H3>
      <Main.P className="mb-[15px]">
        ...
        only to the extent necessary to perform these functions and provide such
        services, and only pursuant to binding contractual obligations requiring
        such third parties to maintain the privacy and security of your data.
      </Main.P>
      <Main.P className="mb-[15px]">
        <b>Compliance with Laws and Law Enforcement</b> Twitter cooperates with
        government and law enforcement officials or private parties to enforce
        and comply with the law. We may disclose any information about you to
        government or law enforcement officials or private parties as we, in our
        sole discretion, believe necessary or appropriate to respond to claims,
        legal process (including subpoenas), to protect the property and rights
        of Twitter or a third party, the safety of the public or any person, to
        prevent or stop any illegal, unethical, or legally actionable activity,
        or to comply with the law.
      </Main.P>
      <Main.P className="mb-[15px]">
        <b>Business Transfers</b> Twitter may sell, transfer or otherwise share
      ...
      <Main.H3>Changing or Deleting Information</Main.H3>
      <Main.P className="mb-[15px]">
      ...
      <Main.P className="mb-[15px]">
        ...
        enforcement or (ii) any measures necessary to determine the scope of the
        breach and restore the reasonable integrity of the data system.
      </Main.P>
      <Main.H3>Links to Other Websites</Main.H3>
      <Main.P className="mb-[15px]">
        ...
        other files on your computer, collect data or solicit personally
      ...
      <Main.H3>Our Policy Towards Children</Main.H3>
      <Main.P className="mb-[15px]">
        ...
        identifiable information without their consent, he or she should contact
        us at{" "}
        <Link href="mailto:privacy@twitter.com">
          privacy at twitter dot com
        </Link>
        . We do not knowingly collect personally identifiable information from
        children under 13. If we become aware that a child under 13 has provided
        us with personal identifiable Information, we will delete such
