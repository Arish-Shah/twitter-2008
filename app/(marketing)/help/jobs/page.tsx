...
export default function Jobs() {
  return (
    <Main>
      <Main.H1>Nice to meet you; won&apos;t you join us?</Main.H1>
      <Main.P>
      ...
      <Main.H2 className="mb-0">Why work at Twitter?</Main.H2>
      <Main.P className="mt-0">
      ...
      <Main.H2 className="mb-0 mt-[10px]">
      ...
      <Main.H1 className="mb-0 mt-[20px]">Our current positions</Main.H1>
      <Main.P className="mt-0">
      ...
      <div id="opseng"></div>
      <Main.H2 className="mb-0 mt-[10px]">Operations Engineer</Main.H2>
      <Main.P className="mt-0">
      ...
      <Main.H4 className="mb-0 mt-[10px]">Key areas of responsibility</Main.H4>
      ...
      <Main.H4 className="mb-0 mt-[10px]">Qualifications</Main.H4>
      <ul className="ml-[0.6px] leading-[16px]">
      ...
      <Main.H4 className="mb-0 mt-[10px]">Bonus</Main.H4>
      <ul className="ml-[0.6px] leading-[16px]">
      ...
      <div id="syseng"></div>
      <Main.H2 className="mb-0 mt-[10px]">Systems Engineer</Main.H2>
      <Main.P className="mt-0">
      ...
      <div id="fe"></div>
      <Main.H2 className="mb-0 mt-[10px]">Front End Engineer</Main.H2>
      <Main.P className="mt-0">
        Twitter is looking for a new member of our technical staff to focus on
