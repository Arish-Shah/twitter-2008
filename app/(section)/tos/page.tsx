...
export default function TOS() {
  return (
    <TwoColumn>
      <TwoColumn.Main>
        <TwoColumn.Main.H2>Terms of Service</TwoColumn.Main.H2>
        <TwoColumn.Main.P>
        ...
        <TwoColumn.Main.H3>Basic Terms</TwoColumn.Main.H3>
        ...
        <TwoColumn.Main.H3>General Conditions</TwoColumn.Main.H3>
      ...
      <TwoColumn.Sidebar>
        <TwoColumn.Sidebar.Section>
          <TwoColumn.Sidebar.H1>Opting-in to SMS Updates</TwoColumn.Sidebar.H1>
          ...
          <TwoColumn.Sidebar.H1>Opting-out of SMS Updates</TwoColumn.Sidebar.H1>
          <TwoColumn.Sidebar.OrderedList>
            <li>
