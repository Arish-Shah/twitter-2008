...
export default function Press() {
  return (
    <TwoColumn>
      <TwoColumn.Main>
        <TwoColumn.Main.H2>About Twitter!</TwoColumn.Main.H2>
        <TwoColumn.Main.P className="mt-[7px] text-[10px]">
        ...
        <TwoColumn.Main.H3>How is Twitter built?</TwoColumn.Main.H3>
        <TwoColumn.Main.P>
        ...
        <TwoColumn.Main.H3>What&apos;s next for Twitter?</TwoColumn.Main.H3>
        <TwoColumn.Main.P>
      ...
      <TwoColumn.Sidebar>
        <TwoColumn.Main.P className="my-0">
          Media inquires:{" "}
